          ...
          {filteredLinks.map((link) => {
            ...
            return (
              <Link key={link.href} href={link.href} className="block">
                <div className="group bg-white rounded-lg border border-gray-200 p-4 hover:shadow-md hover:border-blue-300 transition-all cursor-pointer block no-underline">
